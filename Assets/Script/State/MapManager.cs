...
public class MapManager : MonoBehaviour
{
    ...
    [SerializeField] private Transform[] PrefabObj;
    ...
    [SerializeField] private GameObject actionBar; //행동력 오브젝트 가져올거
    public int actionPoint { get; set; } //행동력 설정
    ...
    public void GenerateMap()
    {
        ...
        for (int i = 0; i < mapSize.x; i++)
        {
            for (int j = 0; j < mapSize.y; j++)
            {
                ...
                Transform newBlock = Instantiate(GroundObj[Data.GetComponent<jsonCode>().mapData_.map[i].mapX[j]], blockPos, Quaternion.identity);
        ...
        for (int i = 0; i < mapSize.x; i++)
        {
            for (int j = 0; j < mapSize.y; j++)
            {
                ...
                {
                    Transform newObj = Instantiate(PrefabObj[0], blockPos + Vector3.up * 0.1f, Quaternion.identity) as Transform;   //오브젝트 생성
                ...
                {
                    Transform newObj = Instantiate(PrefabObj[1], blockPos + Vector3.up * 0.1f, Quaternion.identity) as Transform;   //오브젝트 생성
                    newObj.localScale = Vector3.one * (Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[1]);      //오브젝트 크기 설정
                    newObj.GetComponent<ObjCode>().obj_Ack = (int)Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[2];//오브젝트 소모 행동력 설정
                    newObj.GetComponent<ObjCode>().obj_Speed = Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[3];   //오브젝트 스피드 설정
                ...
                {
                    Transform newObj = Instantiate(PrefabObj[2], blockPos + Vector3.up * 0.01f, Quaternion.identity) as Transform;   //오브젝트 생성
                    newObj.localScale = Vector3.one * (Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[1]);      //오브젝트 크기 설정
                    newObj.GetComponent<ObjCode>().obj_Ack = (int)Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[2];//오브젝트 소모 행동력 설정
                    newObj.GetComponent<ObjCode>().obj_Speed = Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[3];   //오브젝트 스피드 설정
                ...
                {
                    Transform newObj = Instantiate(PrefabObj[3], blockPos + Vector3.up * 0.01f, Quaternion.identity) as Transform;   //오브젝트 생성
                    newObj.localScale = Vector3.one * (Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[1]);      //오브젝트 크기 설정
                ...
                {
                    Transform newObj = Instantiate(PrefabObj[4], blockPos + Vector3.up * 0.1f, Quaternion.identity) as Transform;   //오브젝트 생성
                    newObj.localScale = Vector3.one * (Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[1]);      //오브젝트 크기 설정
                    newObj.GetComponent<ObjCode>().obj_Ack = (int)Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[2];//오브젝트 소모 행동력 설정
                    newObj.GetComponent<ObjCode>().obj_Speed = Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[3];   //오브젝트 스피드 설정
                ...
                {
                    Transform newObj = Instantiate(PrefabObj[5], blockPos + Vector3.up * 0.01f, Quaternion.identity) as Transform;   //오브젝트 생성
                    newObj.localScale = Vector3.one * (Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[1]);      //오브젝트 크기 설정
                    newObj.GetComponent<ObjCode>().obj_Ack = (int)Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[2];//오브젝트 소모 행동력 설정
                    newObj.GetComponent<ObjCode>().obj_Speed = Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[3];   //오브젝트 스피드 설정
                ...
                {
                    Transform newObj = Instantiate(PrefabObj[6], blockPos + Vector3.up * 0.1f, Quaternion.identity) as Transform;   //오브젝트 생성
                    newObj.localScale = Vector3.one * (Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[1]);      //오브젝트 크기 설정
                    newObj.GetComponent<ObjCode>().obj_Ack = (int)Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[2];//오브젝트 소모 행동력 설정
                    newObj.GetComponent<ObjCode>().obj_Speed = Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[3];   //오브젝트 스피드 설정
                ...
                {
                    Transform newObj = Instantiate(PrefabObj[7], blockPos + Vector3.up * 0.3f, Quaternion.identity) as Transform;   //오브젝트 생성
                    newObj.localScale = Vector3.one * (Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[1]);      //오브젝트 크기 설정
                    newObj.GetComponent<ObjCode>().obj_Ack = (int)Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[2];//오브젝트 소모 행동력 설정
                    newObj.GetComponent<ObjCode>().obj_Speed = Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[3];   //오브젝트 스피드 설정
                ...
                {
                    Transform newObj = Instantiate(PrefabObj[8], blockPos + Vector3.up * 0.01f, Quaternion.identity) as Transform;   //오브젝트 생성
                    newObj.localScale = Vector3.one * (Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[1]);      //오브젝트 크기 설정
                    newObj.transform.GetChild(0).GetComponent<ObjCode>().obj_Ack = (int)Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[2];//오브젝트 소모 행동력 설정
                    newObj.transform.GetChild(0).GetComponent<ObjCode>().obj_Speed = Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[3];   //오브젝트 스피드 설정
                ...
                {
                    Transform newObj = Instantiate(PrefabObj[9], blockPos + Vector3.up * 0.01f, Quaternion.identity) as Transform;   //오브젝트 생성
                    newObj.localScale = Vector3.one * (Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[1]);      //오브젝트 크기 설정
                    newObj.transform.GetChild(0).GetComponent<ObjCode>().obj_Ack = (int)Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[2];//오브젝트 소모 행동력 설정
                    newObj.transform.GetChild(0).GetComponent<ObjCode>().obj_Speed = Data.GetComponent<jsonCode>().objData_.map[i].mapX[j].oData[3];   //오브젝트 스피드 설정
